...
## 專業技能
- **核心工具**: Axure, 墨刀 (Modao), Google Workspace, Jira, Confluence, Microsoft 365, Figma
- **技術協作**: Basic API Testing (Postman), Version Control Logic (Git)
- **AI技能**: AI Assisted Development, Generative AI Application, AI Enhanced Workflow
...
- **關鍵責任**:
  ...
  - 協調跨部門合作與時程控管。
- **核心成就**:
  - **AI 效能工作流導入**：建立 **輔助開發流程 (Agentic Workflow)**，提升文件產出的**精準度與跨部門對齊效率**，降低溝通成本。
...
- **核心成就**:
  - **從 0 到 1**：在 **2 個月**內完成產品開發並上線後持續迭代。
...
- **核心成就**:
  ...
  - **產品增長與變現**：規劃 **iOS IAP、MTT 排行榜與 SpinUp 玩法**，提升轉換。
...
- **關鍵責任**:
  - 與部門主管及各部門進行需求訪談與溝通。
  - 研究、規劃與設計休閒娛樂平台之前後端功能、系統以及 UI/UX。
- **核心成就**:
...
- **桌遊作品**:
  - **《猜腳丫》**：獨立設計，版權被新天鵝堡買下並全球發行多國語言。
  - **《Office 21》**：協助設計、出版與集資，版權被新天鵝堡買下並全球發行。
  - **《空錢任務》**：獨立設計，版權被山頂洞人實驗室買斷出版發行。
  - **《Honey Moo》**：宜蘭大學畜牧系委託案，版權被新天鵝堡買下並全球發行。
...
## Skills
- **Core Tools**: Axure, Modao, Google Workspace, Jira, Confluence, Microsoft 365, Figma
- **Technical Collaboration**: Basic API Testing (Postman), Version Control Logic (Git)
- **AI Skills**: AI Assisted Development, Generative AI Application, AI Enhanced Workflow
